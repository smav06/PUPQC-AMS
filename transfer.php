        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold active"><a href="transfer.php" class="waves-effect waves-cyan"><i class="mdi-maps-directions-car"></i> Transfer</a>
                    </li>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <ol class="breadcrumbs">
                  <li class="active"><a href="transfer.php">Transfer</a>
                  </li>
                  <li></li>
                </ol>
              </div>
                  ...
                  <div class="card-panel">
                    <div class="row">
                      ...
                      <div class="input-field col s4">
                        ...
                        <label for="first_name">Current Accountable Person</label>
                      </div>
                    ...
                    <div class="row">
                      <form class="col s12">
                        <div class="row">
                          ...
                          <div class="input-field col s4">
                            <input disabled type="date" class="datepicker">
                        ...
                        <div class="row">
                          <div class="input-field col s4">
                            <select>
                              ...
                              <option value="2">PUP Taguig</option>
                          ...
                          <div class="input-field col s4">
                            ...
                            <label for="first_name">Received By</label>
                          </div>

                          <div class="input-field col s12">
                            <textarea id="description" class="materialize-textarea" maxlength="300"></textarea>
                            <label for="description">Reason for Transfer</label>
                          </div>

                          <div class="row">
                            <div class="input-field col s12">
                              <button style="margin-right: 10px;" class="btn cyan waves-effect waves-light right" type="submit">TRANSFER & PRINT PTR
                              </button>
                            </div>
                          </div>
                        </div>
