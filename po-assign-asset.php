        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-assignment-ind"></i> Assets</a>
                        <div class="collapsible-body">
                            <ul>
                              <li><a href="po-list-of-asset.php">List of Asset</a>
                              </li>
                              <li  class="active"><a href="po-assign-asset.php">Assign Asset</a>
                              </li>
                            </ul>
                        </div>
                    </li>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <ol class="breadcrumbs">
                  <li class="active"><a href="po-assign-asset.php">Assets</a>
                  </li>
                  <li>Assign Asset</li>
                </ol>
              </div>
                ...
                <div class="row">
                  <div class="input-field col s4">
                    <select>
                      ...
                      <option value="1">Office of Student Affairs and Services</option>
                      <option value="2">Guidance Office</option>
                  ...
                  <div class="input-field col s4">
                    <select>
                      ...
                      <option value="3">Michelle</option>
                    </select>
                    <label for="unit">Accountable Person</label>
                  </div>

                  <div class="input-field col s4">
                    <select>
                      <option value="" disabled selected>Select Asset</option>
                      <option value="1">Mac Book</option>
                      <option value="2">Computer AMD</option>
                      <option value="3">Iphone 7s</option>
                    </select>
                    <label for="unit">Asset</label>
                  </div>
                </div>
                  ...
                  <form class="col s12">
                    ...
                    <div class="row">
                      <div class="input-field col s8">
                        <textarea disabled id="description" class="materialize-textarea" maxlength="250"></textarea>
                        <label for="description">Description of Asset</label>
                      </div>

                      <div class="row">
                        <div class="input-field col s4">
                          <button style="margin-right: 10px; margin-top: 55px;" class="btn cyan waves-effect waves-light right" type="submit">Assign & Print PAR
                          </button>
                        </div>
                      </div>
                    </div>
