...
<head>
  ...
  <title>Availability of Asset</title>
                    ...
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-speaker-notes"></i> Requisition</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="po-availability-of-asset.php">Availability of Asset</a>
                                </li>
                            </ul>
                        </div>
                    </li>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <ol class="breadcrumbs">
                  <li><a href="po-availability-of-asset.php">Requisition</a>
                  </li>
                  <li class="active">Availability of Asset</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="section">
            <div class="col s12 m12 l6">
              <h1>List of Request for Asset Availability</h1>
            </div>
