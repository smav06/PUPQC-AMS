        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold active"><a href="du-department-asset.php" class="waves-effect waves-cyan"><i class="mdi-hardware-laptop-chromebook"></i>Department Assets</a>
                    </li>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <ol class="breadcrumbs">
                  <li class="active"><a href="du-department-asset.php">Department Assets</a>
                  </li>
                  <li></li>
                </ol>
              </div>
