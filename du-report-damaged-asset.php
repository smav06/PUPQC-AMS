        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold active"><a href="du-report-damaged-asset.php" class="waves-effect waves-cyan"><i class="mdi-action-report-problem"></i>Report Damaged Asset</a>
                    </li>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <ol class="breadcrumbs">
                  <li class="active"><a href="du-report-damaged-asset.php">Report Damaged Asset</a>
                  </li>
                  <li></li>
                </ol>
              </div>
                      ...
                      <form class="col s12">
                        <div class="row">
                          ...
                          <div class="input-field col s6">
                            ...
                            <label for="month">Complainant</label>
                          </div>
