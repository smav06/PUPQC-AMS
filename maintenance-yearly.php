...
<head>
  ...
  <title>Maintenance | Yearly</title>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-action-settings-applications"></i> Maintenance</a>
                        <div class="collapsible-body">
                            <ul>
                                <li class="active"><a href="maintenance-yearly.php">Yearly Maintenance</a>
	                            </li>
      ...
      <section id="content">
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <ol class="breadcrumbs">
                  <li><a href="maintenance-yearly.php">Maintenance</a>
                  </li>
                  <li class="active">Yearly Maintenance</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="section">
              ...
              <h1>Select Asset You Want To Maintenance</h1>
            </div> -->
