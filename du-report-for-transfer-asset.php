...
<head>
  ...
  <title>Report For Transfer Asset</title>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="du-dashboard.php" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Dashboard</a>
            </li>
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold  active"><a href="du-report-for-transfer-asset.php" class="waves-effect waves-cyan"><i class="mdi-maps-directions-car"></i>Report For Transfer Asset</a>
                    </li>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <ol class="breadcrumbs">
                  <li class="active"><a href="du-report-for-transfer-asset.php">Report For Transfer Asset</a>
                  </li>
                  <li></li>
                </ol>
              </div>
        ...
        <div class="container">
          <div class="section">
            <div class="col s12 m12 l6">
              <h1>REPORT FOR TRANSFER ASSET</h1>
            </div>
                      ...
                      <form class="col s12">
                        <div class="row">
                          ...
                          <div class="input-field col s6">
                            <select>
                              ...
                              <option value="3">Biance</option>
                            </select>
                            <label for="month">Accountable Person</label>
                          </div>
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            ...
                            <label for="description">Reason for Reporting of damaged asset</label>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <button style="margin-right: 10px;" class="btn cyan waves-effect waves-light right" type="submit">Submit
                              </button>
                            </div>
                          </div>
                        </div>
