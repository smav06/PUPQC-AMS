...
<head>
  ...
  <title>View Disposed Asset</title>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-delete"></i> Disposal</a>
                        <div class="collapsible-body">
                            <ul>                                        
                                <li class="active"><a href="po-view-disposed-asset.php">View Disposed Asset</a>
                                </li>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <ol class="breadcrumbs">
                  <li><a href="po-view-disposed-asset.php">Disposal</a>
                  </li>
                  <li class="active">View Disposed Asset</li>
                </ol>
              </div>
            </div>
          </div>
