                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-action-settings-applications"></i> Maintenance</a>
                        <div class="collapsible-body">
                            <ul>
	                            ...
	                            <li class="active"><a href="maintenance-report.php">Report of Damage</a>
	                            </li>
                            </ul>
                        </div>
                    </li>
      ...
      <section id="content">
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <ol class="breadcrumbs">
                  <li><a href="maintenance-report.php">Maintenance</a>
                  </li>
                  <li class="active">Report of Damage</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="section">
              ...
              <h1>List of Reported Damaged Asset</h1>
            </div>
